...
> This is the first stable release (v.1.0.0) of the library. Please raise all issues as you find them, submit pull requests, etc! A link to the working paper which discusses this work can be found [here](github.com) and the corresponding .tex file [here](https://github.com/crahal/centgovspend/tree/master/compile). Please get in touch if you would like to use this tool for your own purposes: I would be happy to help as required.
...
*Next update of scrapers: 1/10/2018*

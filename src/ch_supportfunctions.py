    ...
    with open(os.path.abspath(os.path.join(ch_data_path, 'psc_flatfile.tsv')),
        ...
        with open(os.path.abspath(
            ...
            for line in tqdm(f):
                ...
                try:
                    surname = json.loads(
                        line)['data']['name_elements']['surname']
                except Exception as e:
                    surname = 'N/A'
                try:
                ...
                psc_data.writerow([company_number, address_line_1,
                                   ...
                                   postal_code, region, country_of_residence,
                                   str(date_of_birth), etag, kind, str(links),
                                   name, forename, middle_name, surname, title,
                                   nationality, str(natures_of_control)])
    ...
    if os.path.exists(os.path.abspath(
        ...
        with open(os.path.abspath(
            ...
            officers_data = csv.writer(tsvfile, delimiter='\t',
                                       lineterminator='\n')
            officers_data.writerow(['CompanyNumber', 'Name', 'Officer ID',
                    ...
                    for off in page['items']:
                        ...
                        with open(os.path.abspath(
                            ...
                            officers_data = csv.writer(
                                tsvfile, delimiter='\t',
                                lineterminator='\n')
                            officers_data.writerow([CompanyNumber, Name,
